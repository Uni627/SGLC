#
#  Be sure to run `pod spec lint SGLC.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/l13635692453/SGLC.git", :commit => "7f20e6bcbe3b2243a45a19debe6540777a90138f" }
